...
<body>
    ...
    <form method="POST" action="{{ route('enregistrementpere') }}">
        @csrf
        ...
        <label for="nom_pere">Nom
            <input type="text" placeholder="Entrer le nom du père" name="nompere">
        </label>
        <label for="prenoms_pere">Prenoms
            <input type="text" placeholder="Entrer les prénoms du pere" name="prenompere">
        </label>
            ...
            <label for="datenaiss_pere">Date de naissance
            <input type="date" name="datenaisspere">
        </label>
        <label for="profession_pere">Profession
            <select>
